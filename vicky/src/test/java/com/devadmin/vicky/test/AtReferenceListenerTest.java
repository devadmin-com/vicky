...
public class AtReferenceListenerTest extends TaskListenerTest {
  ...
  public void basicTest() {
    ...
    testEventModel.setType(TaskEventModelType.AT_REFERENCE);
  ...
  @Test
  public void eventShouldNotBeHandledIfCommentDoesNotContainReferenceTest() {
    createContext();
    ...
    assertFalse("message was sent to the channel", messageService.channelMessaged);
    assertFalse("message was sent to privately", messageService.privateMessaged);
  }
